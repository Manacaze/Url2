              ...
              <ul class="nav" ui-nav>
                ...
                <li>
                  ...
                  <ul class="nav-sub">
                    ...
                    <li>
                      <a href="form.select.php" >
                        <span class="nav-text">Select</span>
                      </a>
                    </li>
                    <li>
                      <a href="form.editor.php" >
                        <span class="nav-text">Editor</span>
                      </a>
                    </li>
                    <li>
                      <a href="form.picker.php">
                    ...
                    <li>
                      <a href="form.dropzone.php" class="no-ajax" >
            ...
            <div class="collapse navbar-toggleable-sm" id="collapse">
              ...
              <ul class="nav navbar-nav">
                <li class="nav-item dropdown">
                  ...
                  <div ui-include="'../views/blocks/dropdown.new.php'"></div>
                </li>
              </ul>
              <!-- / -->
            </div>
