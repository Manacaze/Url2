...
$frl_circulo_add = NULL; // Initialize page object first

class cfrl_circulo_add extends cfrl_circulo {
	...
	// Page object name
	var $PageObjName = 'frl_circulo_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["frl_cir_id"] != "") {
				...
				$this->setKey("frl_cir_id", $this->frl_cir_id->CurrentValue); // Set up key
			} else {
				$this->setKey("frl_cir_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "frl_circuloview.php")
	...
	function LoadDefaultValues() {
		$this->circulo->CurrentValue = NULL;
		$this->circulo->OldValue = $this->circulo->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// circulo
		$this->circulo->SetDbValueDef($rsnew, $this->circulo->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($frl_circulo_add)) $frl_circulo_add = new cfrl_circulo_add();

// Page init
$frl_circulo_add->Page_Init();

// Page main
$frl_circulo_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$frl_circulo_add->Page_Render();
?>
...
var CurrentForm = ffrl_circuloadd = new ew_Form("ffrl_circuloadd", "add");

// Validate form
ffrl_circuloadd.Validate = function() {
...
ffrl_circuloadd.Form_CustomValidate = 
...
ffrl_circuloadd.ValidateRequired = true;
<?php } else { ?>
ffrl_circuloadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ffrl_circuloadd.Lists["x_cod_provincia"] = {"LinkField":"x_sms_pro_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_provincia","","",""],"ParentFields":[],"ChildFields":["x_cod_distrito"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sms_provincias"};
ffrl_circuloadd.Lists["x_cod_distrito"] = {"LinkField":"x_sms_dis_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_distrito","","",""],"ParentFields":["x_cod_provincia"],"ChildFields":["x_cod_zona"],"FilterFields":["x_cod_provincia"],"Options":[],"Template":"","LinkTable":"sms_distritos"};
ffrl_circuloadd.Lists["x_cod_zona"] = {"LinkField":"x_frl_zon_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_zona","","",""],"ParentFields":["x_cod_distrito"],"ChildFields":[],"FilterFields":["x_cod_distrito"],"Options":[],"Template":"","LinkTable":"frl_zona"};
...
<?php if (!$frl_circulo_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $frl_circulo_add->ShowPageHeader(); ?>
<?php
$frl_circulo_add->ShowMessage();
?>
<form name="ffrl_circuloadd" id="ffrl_circuloadd" class="<?php echo $frl_circulo_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($frl_circulo_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $frl_circulo_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $frl_circulo_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ffrl_circuloadd.Init();
</script>
<?php
$frl_circulo_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$frl_circulo_add->Page_Terminate();
?>
