...
$frl_zona_edit = NULL; // Initialize page object first

class cfrl_zona_edit extends cfrl_zona {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->frl_zon_id->CurrentValue == "") {
			$this->Page_Terminate("frl_zonalist.php"); // Invalid key, return to list
		}
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->frl_zon_id->FldIsDetailKey)
			$this->frl_zon_id->setFormValue($objForm->GetValue("x_frl_zon_id"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->frl_zon_id->CurrentValue = $this->frl_zon_id->FormValue;
...
// Create page object
if (!isset($frl_zona_edit)) $frl_zona_edit = new cfrl_zona_edit();

// Page init
$frl_zona_edit->Page_Init();

// Page main
$frl_zona_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$frl_zona_edit->Page_Render();
?>
...
var CurrentForm = ffrl_zonaedit = new ew_Form("ffrl_zonaedit", "edit");

// Validate form
ffrl_zonaedit.Validate = function() {
...
ffrl_zonaedit.Form_CustomValidate = 
...
ffrl_zonaedit.ValidateRequired = true;
<?php } else { ?>
ffrl_zonaedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ffrl_zonaedit.Lists["x_cod_provincia"] = {"LinkField":"x_sms_pro_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_provincia","","",""],"ParentFields":[],"ChildFields":["x_cod_distrito"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sms_provincias"};
ffrl_zonaedit.Lists["x_cod_distrito"] = {"LinkField":"x_sms_dis_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_distrito","","",""],"ParentFields":["x_cod_provincia"],"ChildFields":[],"FilterFields":["x_cod_provincia"],"Options":[],"Template":"","LinkTable":"sms_distritos"};
...
<?php } ?>
<?php $frl_zona_edit->ShowPageHeader(); ?>
<?php
$frl_zona_edit->ShowMessage();
?>
<form name="ffrl_zonaedit" id="ffrl_zonaedit" class="<?php echo $frl_zona_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($frl_zona_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $frl_zona_edit->Token ?>">
<?php } ?>
...
<?php if ($frl_zona->frl_zon_id->Visible) { // frl_zon_id ?>
	<div id="r_frl_zon_id" class="form-group">
		<label id="elh_frl_zona_frl_zon_id" class="col-sm-2 control-label ewLabel"><?php echo $frl_zona->frl_zon_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $frl_zona->frl_zon_id->CellAttributes() ?>>
<span id="el_frl_zona_frl_zon_id">
<span<?php echo $frl_zona->frl_zon_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $frl_zona->frl_zon_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="frl_zona" data-field="x_frl_zon_id" name="x_frl_zon_id" id="x_frl_zon_id" value="<?php echo ew_HtmlEncode($frl_zona->frl_zon_id->CurrentValue) ?>">
<?php echo $frl_zona->frl_zon_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $frl_zona_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
