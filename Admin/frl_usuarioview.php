...
$frl_usuario_view = NULL; // Initialize page object first

class cfrl_usuario_view extends cfrl_usuario {
	...
	// Page object name
	var $PageObjName = 'frl_usuario_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["usuarioId"] <> "") {
			$this->RecKey["usuarioId"] = $_GET["usuarioId"];
			$KeyUrl .= "&amp;usuarioId=" . urlencode($this->RecKey["usuarioId"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["usuarioId"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["usuarioId"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["usuarioId"] <> "") {
				...
				$this->RecKey["usuarioId"] = $this->usuarioId->QueryStringValue;
			} elseif (@$_POST["usuarioId"] <> "") {
				$this->usuarioId->setFormValue($_POST["usuarioId"]);
				$this->RecKey["usuarioId"] = $this->usuarioId->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("frl_usuariolist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->usuarioId->CurrentValue) == strval($this->Recordset->fields('usuarioId'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "frl_usuariolist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "frl_usuariolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($frl_usuario_view)) $frl_usuario_view = new cfrl_usuario_view();

// Page init
$frl_usuario_view->Page_Init();

// Page main
$frl_usuario_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$frl_usuario_view->Page_Render();
?>
...
var CurrentForm = ffrl_usuarioview = new ew_Form("ffrl_usuarioview", "view");

// Form_CustomValidate event
ffrl_usuarioview.Form_CustomValidate = 
...
ffrl_usuarioview.ValidateRequired = true;
<?php } else { ?>
ffrl_usuarioview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ffrl_usuarioview.Lists["x_usuNivelAcesso"] = {"LinkField":"x_usuTipoId","Ajax":true,"AutoFill":false,"DisplayFields":["x_usuTipoNome","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"frl_tipo_usuario"};
ffrl_usuarioview.Lists["x_UsuarioSexo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ffrl_usuarioview.Lists["x_UsuarioSexo"].Options = <?php echo json_encode($frl_usuario->UsuarioSexo->Options()) ?>;
ffrl_usuarioview.Lists["x_UsuarioEstado"] = {"LinkField":"x_frl_usuario_estado_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_frl_usuario_estado_nome","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"frl_usuario_estado"};
...
<?php if ($frl_usuario->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$frl_usuario_view->IsModal) { ?>
<?php if ($frl_usuario->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $frl_usuario_view->ExportOptions->Render("body") ?>
<?php
	foreach ($frl_usuario_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$frl_usuario_view->IsModal) { ?>
<?php if ($frl_usuario->Export == "") { ?>
...
<?php } ?>
<?php $frl_usuario_view->ShowPageHeader(); ?>
<?php
$frl_usuario_view->ShowMessage();
?>
<form name="ffrl_usuarioview" id="ffrl_usuarioview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($frl_usuario_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $frl_usuario_view->Token ?>">
<?php } ?>
...
<?php if ($frl_usuario->usuarioId->Visible) { // usuarioId ?>
	<tr id="r_usuarioId">
		<td><span id="elh_frl_usuario_usuarioId"><?php echo $frl_usuario->usuarioId->FldCaption() ?></span></td>
...
<?php echo $frl_usuario->usuarioId->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($frl_usuario->nome->Visible) { // nome ?>
	<tr id="r_nome">
		<td><span id="elh_frl_usuario_nome"><?php echo $frl_usuario->nome->FldCaption() ?></span></td>
...
<?php echo $frl_usuario->nome->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($frl_usuario->UsuarioApelido->Visible) { // UsuarioApelido ?>
	<tr id="r_UsuarioApelido">
		<td><span id="elh_frl_usuario_UsuarioApelido"><?php echo $frl_usuario->UsuarioApelido->FldCaption() ?></span></td>
...
<?php echo $frl_usuario->UsuarioApelido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($frl_usuario->usuarioNome->Visible) { // usuarioNome ?>
	<tr id="r_usuarioNome">
		<td><span id="elh_frl_usuario_usuarioNome"><?php echo $frl_usuario->usuarioNome->FldCaption() ?></span></td>
...
<?php echo $frl_usuario->usuarioNome->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($frl_usuario->UsuarioEmail->Visible) { // UsuarioEmail ?>
	<tr id="r_UsuarioEmail">
		<td><span id="elh_frl_usuario_UsuarioEmail"><?php echo $frl_usuario->UsuarioEmail->FldCaption() ?></span></td>
...
<?php echo $frl_usuario->UsuarioEmail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($frl_usuario->usuarioSenha->Visible) { // usuarioSenha ?>
	<tr id="r_usuarioSenha">
		<td><span id="elh_frl_usuario_usuarioSenha"><?php echo $frl_usuario->usuarioSenha->FldCaption() ?></span></td>
...
<?php echo $frl_usuario->usuarioSenha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($frl_usuario->usuNivelAcesso->Visible) { // usuNivelAcesso ?>
	<tr id="r_usuNivelAcesso">
		<td><span id="elh_frl_usuario_usuNivelAcesso"><?php echo $frl_usuario->usuNivelAcesso->FldCaption() ?></span></td>
...
<?php echo $frl_usuario->usuNivelAcesso->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($frl_usuario->UsuarioSexo->Visible) { // UsuarioSexo ?>
	<tr id="r_UsuarioSexo">
		<td><span id="elh_frl_usuario_UsuarioSexo"><?php echo $frl_usuario->UsuarioSexo->FldCaption() ?></span></td>
...
<?php echo $frl_usuario->UsuarioSexo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($frl_usuario->UsuarioEstado->Visible) { // UsuarioEstado ?>
	<tr id="r_UsuarioEstado">
		<td><span id="elh_frl_usuario_UsuarioEstado"><?php echo $frl_usuario->UsuarioEstado->FldCaption() ?></span></td>
...
<?php echo $frl_usuario->UsuarioEstado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($frl_usuario->usuarioAvatar->Visible) { // usuarioAvatar ?>
	<tr id="r_usuarioAvatar">
		<td><span id="elh_frl_usuario_usuarioAvatar"><?php echo $frl_usuario->usuarioAvatar->FldCaption() ?></span></td>
		<td data-name="usuarioAvatar"<?php echo $frl_usuario->usuarioAvatar->CellAttributes() ?>>
<span id="el_frl_usuario_usuarioAvatar">
<span>
<?php echo ew_GetFileViewTag($frl_usuario->usuarioAvatar, $frl_usuario->usuarioAvatar->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if (!$frl_usuario_view->IsModal) { ?>
<?php if ($frl_usuario->Export == "") { ?>
<?php if (!isset($frl_usuario_view->Pager)) $frl_usuario_view->Pager = new cPrevNextPager($frl_usuario_view->StartRec, $frl_usuario_view->DisplayRecs, $frl_usuario_view->TotalRecs) ?>
<?php if ($frl_usuario_view->Pager->RecordCount > 0 && $frl_usuario_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($frl_usuario_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $frl_usuario_view->PageUrl() ?>start=<?php echo $frl_usuario_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($frl_usuario_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $frl_usuario_view->PageUrl() ?>start=<?php echo $frl_usuario_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $frl_usuario_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($frl_usuario_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $frl_usuario_view->PageUrl() ?>start=<?php echo $frl_usuario_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($frl_usuario_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $frl_usuario_view->PageUrl() ?>start=<?php echo $frl_usuario_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $frl_usuario_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
...
<?php if ($frl_usuario->Export == "") { ?>
<script type="text/javascript">
ffrl_usuarioview.Init();
</script>
<?php } ?>
<?php
$frl_usuario_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($frl_usuario->Export == "") { ?>
...
<?php
$frl_usuario_view->Page_Terminate();
?>
