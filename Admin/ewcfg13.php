...
define("EW_PROJECT_NAME", "Frelimo", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{286C4D49-9D44-49E9-A580-A7321FF88E9C}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'Ql8f165gN9sAFpmh', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Frelimo.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "s1719", "qs" => "`", "qe" => "`");
...
define("EW_UPLOAD_DEST_PATH", "../assets/images/usuarios/", TRUE); // Upload destination path (relative to app root)
...
define("EW_IMAGE_ALLOWED_FILE_EXT", "gif,jpg,png,bmp,jpeg", TRUE); // Allowed file extensions for images
